		...
		<div className="min-h-screen bg-background">
			...
			<main className="relative flex items-center justify-center min-h-[calc(100vh-80px)] p-6 overflow-hidden">
				...
				<div className="absolute inset-0 -z-10">
					<div className="absolute top-1/4 right-1/4 w-72 h-72 bg-blue-50 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-pulse"></div>
					<div className="absolute bottom-1/4 left-1/4 w-72 h-72 bg-purple-50 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-pulse" style={{animationDelay: "2s"}}></div>
				</div>
